<x-app-layout-produto>
    <div class="bg-white">
        <main class="my-8">
            @if (is_null($produto))
                <div class="h-screen w-screen bg-white flex items-center">
                    <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
                        <div class="max-w-md">
                            <p class="text-2xl md:text-3xl font-light leading-normal">Desculpa. Não encontramos esse produto</p>
                        </div>
                        <div class="max-w-lg">
            ...
            @else
                @if (!is_null($produto) && $produto->ativo == 1)
                ...
                @else
                    <div class="h-screen w-screen bg-white flex items-center">
                        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
                            <div class="max-w-md">
                                <p class="text-2xl md:text-3xl font-light leading-normal">Anúncio Pausado</p>
                            </div>
                        </div>
                    </div>
                @endif
